...
// Adapted from otlp-logger (https://github.com/Vunovati/otlp-logger)
// Copyright (c) 2023 Vladimir Adamić, licensed under MIT.
// This file replicates the logic of otlp-logger's getOtlpLogger,
// create-log-processor, and exporter creation using the same OpenTelemetry
// SDK packages directly, without the otlp-logger wrapper dependency.
 ...
 * @property {Omit<import('@opentelemetry/sdk-logs').BatchLogRecordProcessorOptions, 'exporter'>} [processorConfig]
 *
